...
$(document).ready(() => {
  ...
  const socket = new WebSocket(protocol + "https://deltacloud.azurewebsites.net");
  ...
  webSocket.onmessage = function onMessage(message) {
    try {
      ...
      var distance = messageData.IotData.distance;

      console.log
      if(distance !== null){
        var p = document.getElementById("distance-p");
        p.innerHTML = "Distance: "+distance+" cm";
      }
